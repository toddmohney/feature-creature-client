...
Elm.Product.make = function (_elm) {
   ...
   var PlaceholderAction = {ctor: "PlaceholderAction"};
...
Elm.ProductList = Elm.ProductList || {};
Elm.ProductList.make = function (_elm) {
   "use strict";
   _elm.ProductList = _elm.ProductList || {};
   if (_elm.ProductList.values)
   return _elm.ProductList.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var viewProduct = function (model) {
      return $Product.view(model);
   };
   var UpdateProducts = function (a) {
      return {ctor: "UpdateProducts"
             ,_0: a};
   };
   var RequestProducts = {ctor: "RequestProducts"};
   ...
   model) {
      return function () {
         ...
         _L.fromArray([A2($Html.ul,
                      ...
                      address,
                      RequestProducts)]),
                      _L.fromArray([$Html.text("Reload products")]))]));
      }();
   });
   var jsonToProducts = $Json$Decode.list(A4($Json$Decode.object3,
   $Product.Model,
   A2($Json$Decode._op[":="],
   "id",
   $Json$Decode.$int),
   ...
   "repoUrl",
   $Json$Decode.string)));
   var getProductList = function (url) {
      return $Effects.task($Task.map(UpdateProducts)($Task.toResult(A2($Http.get,
      jsonToProducts,
      url))));
   };
   ...
   _elm.ProductList.values = {_op: _op
                             ,Model: Model
                             ,init: init
                             ,getProductList: getProductList
                             ,jsonToProducts: jsonToProducts
